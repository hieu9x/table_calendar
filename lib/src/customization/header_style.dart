...
class HeaderStyle {
  ...
  const HeaderStyle({
    ...
    this.titleTextStyle = const TextStyle(fontSize: 16.0,fontWeight: FontWeight.w400,color: Color(0xff0B0C21)),
    ...
    this.leftChevronIcon = const Icon(Icons.chevron_left,color: Color(0xff0B0C21),),
    this.rightChevronIcon = const Icon(Icons.chevron_right,color: Color(0xff0B0C21),),
